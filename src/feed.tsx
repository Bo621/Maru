...
export function Feed({query}: {query: string}) {
    ...
    return <main id="main-content" className="page-shell">
        ...
        <p className="filter-caveat">판정은 업비트 1분봉으로 다시 계산한 결과입니다. 관측이 끝난 구간은 배포 시점에 계산해 담아 둔 값입니다. 그 뒤에 끝난 구간은 이 화면이 조회를 시도하지만, 업비트가 브라우저 요청을 제한해 바로 뜨지 않을 수 있습니다. 온체인에 기록된 판정이 아닙니다.</p>
